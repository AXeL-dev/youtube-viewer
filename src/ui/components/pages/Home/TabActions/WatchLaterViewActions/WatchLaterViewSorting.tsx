...
interface WatchLaterViewSortingProps {}

function WatchLaterViewSorting(props: WatchLaterViewSortingProps) {
  const sorting = useAppSelector(selectViewSorting(HomeView.WatchLater));
...
export default WatchLaterViewSorting;
